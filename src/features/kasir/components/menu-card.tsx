...
export default function MenuCard({ menu }: MenuCardProps) {
  return (
    <li className="p-4 border-t border-neutral-300 flex items-center gap-4">
      <img src={menu.image || "/images/menu-placeholder.png"} alt={menu.name} className="size-[60px] rounded-lg border border-neutral-300" />
