    ...
    <div className="p-4">
      ...
      <div className="grid grid-cols-2 gap-4 items-center w-full">
        <div className="bg-white rounded-xl p-3 border border-neutral-300">
          ...
          <p className={`font-semibold ${cashflow.totalIncomes > 0 ? "text-green-500 before:content-['+_']" : "text-neutral-500"}`}>{formatCurrency(cashflow.totalIncomes)}</p>
        ...
        <div className="bg-white rounded-xl p-3 border border-neutral-300">
          ...
          <p className={`font-semibold ${cashflow.totalIncomes > 0 ? "text-red-500 before:content-['-_']" : "text-neutral-500"}`}>{formatCurrency(cashflow.totalOutcomes)}</p>
